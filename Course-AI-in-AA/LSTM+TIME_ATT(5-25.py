...
from tensorflow.keras.layers import Dense, Lambda, Dot, Activation, Concatenate, Model
...
history = Model.fit(train_THETA, train_CIP, epochs=2, verbose=2)
print(Model.summary())
#Model.save_weights('Model/Cip_LSTM^2_att_4_2_8_4_1_500.h5')
